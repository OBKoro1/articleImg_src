 ...
 * @LastEditors: OBKoro1
 * @LastEditTime: 2019-06-04 11:30:36
...
class markdownImageDown {
    ...
    reg(type) {
        ...
        let regObj = {
            ...
            sectionUrl: new RegExp(`(${replaceSlash(http)}${jointReg(this.option.varNum)}`, 'g'),
            // 根据url匹配整个图片url
                        ...
                        if (regUrl.indexOf(this.option.replace_image_url) !== -1) {
                            if (replace) {
                                ...
                                try {
                                    ...
                                    throw `请检查new_image_url、varNum的设置：${err}`
                                }
